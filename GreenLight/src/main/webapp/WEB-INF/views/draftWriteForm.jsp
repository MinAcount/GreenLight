							...
							<div id="content">
								<div style="width: 100%; margin-top: 30px;">
									<table class="template" style="width: 100%;">
										...
										<tr>
											<th>반차 여부</th>
											<td><input type="checkbox" value="시작일"> <label>시작일</label>
												( <input type="radio" value="오전"> <label>오전</label>
												<input type="radio" value="오후"> <label>오후</label> )
												<input type="checkbox" value="종료일"> <label>종료일</label>
												( <input type="radio" value="오전"> <label>오전</label>
												<input type="radio" value="오후"> <label>오후</label> )
											</td>
										</tr>
										<tr>
											...
											</span> <span> <b>신청연차 : </b> <input type="text">
											</span></td>
										</tr>
										<tr>
							...
							<nav class="nav nav-borders">
								<ul
									...
									<li class="nav-link active ms-0"
										onclick="getApprLine(); setActive(this)">결재선</li>
									<li class="nav-link" id="doc_status1"
										onclick="getRefLine(); setActive(this)">참조자</li>
								</ul>
							</nav>
						</div>
						<hr class="mt-0 mb-5">
