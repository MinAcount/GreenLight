         ...
         <div id="main_content">
            ...
            <div class="modal fade" id="templateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
               ...
               <div>
                  ...
                  <button class="btn btn-secondary " type="button" data-bs-toggle="modal" data-bs-target="#approvalModal" style="margin-right: 5px;">결재선 설정</button>
                  ...
                  <div class="modal-dialog">
                     <div class="modal-content" style="width: 800px; height: 630px;">
                        ...
                        <div class="modal-body" style="display: flex; flex-direction: column; justify-content: space-between; margin-top: 15px;">
                           <div class="toast-body" style="display: flex; flex-direction: row; justify-content: space-around;">
                              <!-- 결재자들(js tree) -->
                              <div id="approval_sel" style="width: 300px; min-height: 450px; border: 1px solid black; padding: 10px;">
                                 <div id="search_box">
                                    <input id="search_input" type="text">
                                 </div>
                                 <div id="apprJstree" style="margin-top:10px; border: 1px solid black; width: 100%; max-height:390px; overflow-y: scroll;"></div>
                                 <style>
                                 .jstree-node,
                                 .jstree-children,
                                 .jstree-container-ul {
                              ...
                              <div style="width: 50px; text-align: center;">
                                 <button id="addEmp" class="btn btn-primary" style="width: 30px; height: 100px; margin-top: 180px">얍</button>
                              </div>
                              <!-- 선택된 결재자들 -->
                              <div id="apr_chk" style="width: 300px; min-height: 450px; border: 1px solid black; padding-top: 30px;"></div>
                           </div>
                           <div class="modal-footer" style="margin-bottom: 20px; margin-top: 10px;">
                              ...
                              <button data-bs-dismiss="modal" onclick="apprDone()" class="btn btn-primary " type="button" style="margin-left: 10px;">완료</button>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <button class="btn btn-secondary " type="button"">참조자 추가</button>
               </div>
               <div>
                  <button class="btn btn-secondary " type="button" style="margin-right: 5px;">임시저장</button>
                  <button class="btn btn-primary " type="button" style="width: 73.6px;" onclick="insertDocument()">상신</button>
               </div>
            </div>
            <div style="display: flex; flex-direction: row; padding-top: 20px; padding-bottom: 20px; min-height: 800px;">
               <div id="templateArea">
                           ...
                           <table class="template">
                              <tr>
                                 ...
                                 <td id="draftWriter" style="width: 180px;" class="paddingL10">
                                 	<input type="text" name="name" value="${sessionScope.loginVo.name}" readonly="readonly">
                                 	<input type="hidden" name="writer_id" value="${sessionScope.loginVo.id}">
                                 </td>
                              </tr>
                              <tr>
                                 <th>소속부서</th>
                                 <td class="paddingL10">
                                 	<input type="text" name="dname" value="${deptVo.dname}">
                                 </td>
                              </tr>
                              <tr>
                                 <th>기안일</th>
                        ...
                        <div style="width: 100%; margin-top: 30px;">
                           <table class="template" style="width: 100%;">
                              ...
                              <tr>
                                 <th>반차 여부</th>
                                 <td>
                                 	<input type="checkbox" name="start_day" value="시작일" onchange="radioActiveS(this.checked)"><label>시작일</label>
                                 	(<input type="radio" name="시작일" value="오전" disabled="disabled"><label>오전</label>
                                 	<input type="radio" name="시작일" value="오후" disabled="disabled"><label>오후</label>)
                                 	<input type="checkbox" name="end_day" value="종료일" onchange="radioActiveE(this.checked)"><label>종료일</label>
                                 	(<input type="radio" name="종료일" value="오전" disabled="disabled"><label>오전</label>
                                 	<input type="radio" name="종료일" value="오후" disabled="disabled"><label>오후</label>)
                                 </td>
                              </tr>
                              <tr>
                                 <th>연차 일수</th>
                              ...
                              <tr>
                              	<th>긴급 여부</th>
                              	<td><input type="checkbox" name="urgency"></td>
                              </tr>
                              <tr>
                  ...
                  <div>
                     <nav class="nav nav-borders">
                        <ul
                           ...
                           <li class="nav-link active ms-0" onclick="getApprLine(); setActive(this)">결재선</li>
                           <li class="nav-link" id="doc_status1" onclick="getRefLine(); setActive(this)">참조자</li>
                        </ul>
                     </nav>
                  </div>
                  <hr class="mt-0 mb-5">
